...
export default function Home() {
    ...
    return (
        <>
            <Container maxWidth="md" sx={{marginTop: "180px", marginBottom: "40px"}}>
                <Box sx={{textAlign: "center", height: "35vh"}}>
                    ...
                    <Button variant="contained" sx={{fontSize: "15px", marginTop: "30px"}} onClick={handleClick}>Iniciar sesión</Button>
                </Box>
