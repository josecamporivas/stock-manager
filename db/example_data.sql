...
((select buy_id from buys where date = '2023-10-23 19:45:23'), (select product_id from products where name = 'Manzana'), 1.00, 100000),
((select buy_id from buys where date = '2023-10-23 19:45:23'), (select product_id from products where name = 'Pera'), 0.75, 75000),
((select buy_id from buys where date = '2023-10-23 19:45:23'), (select product_id from products where name = 'Plátano'), 1.50, 50000),
((select buy_id from buys where date = '2023-10-23 19:45:23'), (select product_id from products where name = 'Naranja'), 1.25, 125000),
((select buy_id from buys where date = '2023-10-23 19:45:23'), (select product_id from products where name = 'Uva'), 2.00, 150000),
((select buy_id from buys where date = '2023-10-25 06:32:14'), (select product_id from products where name = 'Fresa'), 2.50, 100000),
((select buy_id from buys where date = '2023-10-25 06:32:14'), (select product_id from products where name = 'Sandía'), 3.00, 50000),
((select buy_id from buys where date = '2023-10-25 06:32:14'), (select product_id from products where name = 'Melón'), 3.50, 75000),
((select buy_id from buys where date = '2023-10-25 06:32:14'), (select product_id from products where name = 'Pimiento'), 1.00, 100000),
((select buy_id from buys where date = '2023-10-25 06:32:14'), (select product_id from products where name = 'Tomate'), 0.75, 75000),
((select buy_id from buys where date = '2023-10-25 06:32:14'), (select product_id from products where name = 'Pepino'), 1.50, 50000),
((select buy_id from buys where date = '2023-10-28 14:20:19'), (select product_id from products where name = 'Lechuga'), 1.25, 125000),
((select buy_id from buys where date = '2023-10-28 14:20:19'), (select product_id from products where name = 'Espinaca'), 2.00, 150000),
((select buy_id from buys where date = '2023-10-28 14:20:19'), (select product_id from products where name = 'Coliflor'), 2.50, 100000),
((select buy_id from buys where date = '2023-10-28 14:20:19'), (select product_id from products where name = 'Brócoli'), 3.00, 50000),
((select buy_id from buys where date = '2023-10-28 14:20:19'), (select product_id from products where name = 'Zanahoria'), 3.50, 75000),
((select buy_id from buys where date = '2023-10-28 14:20:19'), (select product_id from products where name = 'Patata'), 1.00, 100000),
((select buy_id from buys where date = '2023-10-28 14:20:19'), (select product_id from products where name = 'Cebolla'), 0.75, 75000),
((select buy_id from buys where date = '2023-11-04 14:04:58'), (select product_id from products where name = 'Ajo'), 1.50, 50000),
((select buy_id from buys where date = '2023-11-04 14:04:58'), (select product_id from products where name = 'Calabaza'), 1.25, 125000),
((select buy_id from buys where date = '2023-11-04 14:04:58'), (select product_id from products where name = 'Calabacín'), 2.00, 150000),
((select buy_id from buys where date = '2023-11-04 14:04:58'), (select product_id from products where name = 'Berenjena'), 2.50, 100000),
((select buy_id from buys where date = '2023-11-07 17:05:54'), (select product_id from products where name = 'Champiñón'), 3.00, 50000),
((select buy_id from buys where date = '2023-11-07 17:05:54'), (select product_id from products where name = 'Seta'), 3.50, 75000);
...
INSERT INTO `buy_contains_product` VALUES
((select buy_id from buys where date = '2023-10-23 19:45:24'), (select product_id from products where name = 'Carne de vacuno'), 5.00, 100000),
((select buy_id from buys where date = '2023-10-23 19:45:24'), (select product_id from products where name = 'Carne de cerdo'), 4.00, 75000),
((select buy_id from buys where date = '2023-10-23 19:45:24'), (select product_id from products where name = 'Carne de pollo'), 3.00, 50000),
((select buy_id from buys where date = '2023-10-25 06:32:15'), (select product_id from products where name = 'Carne de cordero'), 6.00, 125000),
((select buy_id from buys where date = '2023-10-25 06:32:15'), (select product_id from products where name = 'Carne de conejo'), 7.00, 150000),
((select buy_id from buys where date = '2023-10-28 14:20:12'), (select product_id from products where name = 'Carne de pavo'), 8.00, 100000),
((select buy_id from buys where date = '2023-10-28 14:20:12'), (select product_id from products where name = 'Carne de pato'), 9.00, 50000),
((select buy_id from buys where date = '2023-10-28 14:20:12'), (select product_id from products where name = 'Carne de avestruz'), 10.00, 75000),
((select buy_id from buys where date = '2023-11-04 14:05:58'), (select product_id from products where name = 'Carne de caballo'), 11.00, 100000),
((select buy_id from buys where date = '2023-11-04 14:05:58'), (select product_id from products where name = 'Carne de buey'), 12.00, 125000);
...
INSERT INTO `buy_contains_product` VALUES
((select buy_id from buys where date = '2023-10-23 19:45:26'), (select product_id from products where name = 'Bacalao'), 5.00, 100000),
((select buy_id from buys where date = '2023-10-23 19:45:26'), (select product_id from products where name = 'Salmón'), 4.00, 75000),
((select buy_id from buys where date = '2023-10-23 19:45:26'), (select product_id from products where name = 'Atún'), 3.00, 50000),
((select buy_id from buys where date = '2023-10-25 06:32:16'), (select product_id from products where name = 'Merluza'), 6.00, 125000),
((select buy_id from buys where date = '2023-10-25 06:32:16'), (select product_id from products where name = 'Lubina'), 7.00, 150000),
((select buy_id from buys where date = '2023-10-28 14:20:21'), (select product_id from products where name = 'Dorada'), 8.00, 100000),
((select buy_id from buys where date = '2023-10-28 14:20:21'), (select product_id from products where name = 'Sardina'), 9.00, 50000),
((select buy_id from buys where date = '2023-11-04 14:04:59'), (select product_id from products where name = 'Boquerón'), 10.00, 75000),
((select buy_id from buys where date = '2023-11-04 14:04:59'), (select product_id from products where name = 'Anchoa'), 11.00, 100000),
((select buy_id from buys where date = '2023-11-04 14:04:59'), (select product_id from products where name = 'Pulpo'), 12.00, 125000);
...
INSERT INTO `buy_contains_product` VALUES
((select buy_id from buys where date = '2023-10-23 19:45:13'), (select product_id from products where name = 'Barra de pan artesano'), 0.50, 100000),
((select buy_id from buys where date = '2023-10-25 06:33:14'), (select product_id from products where name = 'Chapata'), 0.75, 75000),
((select buy_id from buys where date = '2023-10-29 14:20:19'), (select product_id from products where name = 'Barra de pan normal'), 1.00, 50000),
((select buy_id from buys where date = '2023-10-29 14:20:19'), (select product_id from products where name = 'Pan de espelta'), 1.25, 125000),
((select buy_id from buys where date = '2023-11-04 15:04:58'), (select product_id from products where name = 'Pan integral'), 1.50, 150000),
((select buy_id from buys where date = '2023-11-04 15:04:58'), (select product_id from products where name = 'Pan de maíz'), 1.75, 100000);
...
INSERT INTO `buy_contains_product` VALUES
((select buy_id from buys where date = '2023-10-23 19:35:23'), (select product_id from products where name = 'Detergente'), 5.00, 100000),
((select buy_id from buys where date = '2023-10-23 19:35:23'), (select product_id from products where name = 'Suavizante'), 4.00, 75000),
((select buy_id from buys where date = '2023-10-23 19:35:23'), (select product_id from products where name = 'Lejía'), 3.00, 50000),
((select buy_id from buys where date = '2023-10-25 06:31:14'), (select product_id from products where name = 'Limpiador'), 6.00, 125000),
((select buy_id from buys where date = '2023-10-25 06:31:14'), (select product_id from products where name = 'Desinfectante'), 7.00, 150000),
((select buy_id from buys where date = '2023-10-25 06:31:14'), (select product_id from products where name = 'Ambientador'), 8.00, 100000),
((select buy_id from buys where date = '2023-10-25 06:31:14'), (select product_id from products where name = 'Insecticida'), 9.00, 50000),
((select buy_id from buys where date = '2023-10-25 06:31:14'), (select product_id from products where name = 'Repelente'), 10.00, 75000),
((select buy_id from buys where date = '2023-10-25 06:31:14'), (select product_id from products where name = 'Cera'), 11.00, 100000),
((select buy_id from buys where date = '2023-10-25 06:31:14'), (select product_id from products where name = 'Fregasuelos'), 12.00, 125000);